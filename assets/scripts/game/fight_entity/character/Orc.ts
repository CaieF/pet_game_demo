...
@RegisterCharacter({id: "Orc"})
class Character extends CharacterMetaState {

    name: string = "哥布林小弟"

    AnimationDir: string = "game/fight_entity/character/Orc"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/Orc/avatar/spriteFrame"
    ...
    AttackGrowth: number = 10

    DefenceGrowth: number = 5

    PierceGrowth: number = 3

    SpeedGrowth: number = 8
