...
@RegisterCharacter({id: "SlimeOrdinary"})
class Character extends CharacterMetaState {

    name: string = "小棕史莱姆"

    AnimationDir: string = "game/fight_entity/character/SlimeOrdinary"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/SlimeOrdinary/avatar/spriteFrame"
