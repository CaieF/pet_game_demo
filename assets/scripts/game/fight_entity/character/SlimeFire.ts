...
@RegisterCharacter({id: "SlimeFire"})
class Character extends CharacterMetaState {

    name: string = "小红史莱姆"

    AnimationDir: string = "game/fight_entity/character/SlimeFire"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/SlimeFire/avatar/spriteFrame"
