...
@RegisterCharacter({id: "SlimeGold"})
class Character extends CharacterMetaState {

    name: string = "小银史莱姆"

    AnimationDir: string = "game/fight_entity/character/SlimeGold"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/SlimeGold/avatar/spriteFrame"
