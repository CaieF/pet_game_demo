...
@RegisterCharacter({id: "SlimeTree"})
class Character extends CharacterMetaState {

    name: string = "小绿史莱姆"

    AnimationDir: string = "game/fight_entity/character/SlimeTree"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/SlimeTree/avatar/spriteFrame"
