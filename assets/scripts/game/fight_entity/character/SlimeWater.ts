...
@RegisterCharacter({id: "SlimeWater"})
class Character extends CharacterMetaState {

    name: string = "小蓝史莱姆"

    AnimationDir: string = "game/fight_entity/character/SlimeWater"

    AnimationType: "DragonBones" | "Spine" = "DragonBones"

    AvatarPath: string = "game/fight_entity/character/SlimeWater/avatar/spriteFrame"
